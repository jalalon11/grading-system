        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form id="editSubjectForm" action="{{ route('teacher-admin.subjects.update', $subject) }}" method="POST">
                        @csrf
                        @method('PUT')
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select @error('grade_level') is-invalid @enderror" id="grade_level" name="grade_level">
                                                ...
                                                @foreach($gradeLevels as $grade)
                                                    <option value="Grade {{ $grade }}" {{ old('grade_level', $subject->grade_level ? 'Grade ' . $subject->grade_level : '') == "Grade {$grade}" ? 'selected' : '' }}>
                                                        Grade {{ $grade }}
                                                    </option>
                                                @endforeach
                                            </select>
                                ...
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="alert alert-info">
                                            ...
                                            This subject is currently <strong>{{ $subject->is_active ? 'active' : 'inactive' }}</strong>.
                                            You can change its status from the subjects list.
                                        </div>
                                    </div>
                                </div>
                            </div>
