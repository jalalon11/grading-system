                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <div id="batch_example" class="alert alert-secondary" style="display: none;">
                                        ...
                                        <pre class="mb-0 bg-light p-2 rounded code-sample">Mathematics, MATH7, Grade 7, Basic mathematics for 7th grade
Science, SCI7, Grade 7, General science including basic physics and chemistry
English, ENG7, Grade 7, English language and literature
Filipino, FIL7, Grade 7
History, HIST7, Grade 7, Philippine history and culture</pre>
                                    </div>
                                    
                                    <div class="form-group mb-3">
                                        <label for="batch_subjects" class="form-label fw-bold">Subjects (one per line) <span class="text-danger">*</span></label>
                                        <textarea class="form-control @error('batch_subjects') is-invalid @enderror" id="batch_subjects" name="batch_subjects" rows="10" placeholder="Mathematics, MATH7, 7, Basic mathematics course&#10;Science, SCI7, 7, General science course&#10;English, ENG7, 7, English language and literature">{{ old('batch_subjects') }}</textarea>
