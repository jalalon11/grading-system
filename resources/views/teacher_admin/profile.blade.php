            ...
            <div class="card profile-card border-0 shadow-sm h-100">
                <div class="card-header profile-header text-white py-3">
                    <h5 class="mb-0 d-flex align-items-center">
                        ...
                        <span>Teacher Admin Profile</span>
                    </h5>
                </div>
                ...
                <div class="card-body p-0">
                    <div class="tab-content" id="profileTabsContent">
                        ...
                        <div class="tab-pane fade" id="edit-profile-tab-pane" role="tabpanel" aria-labelledby="edit-profile-tab" tabindex="0">
                            <div class="p-4">
                                <form action="{{ route('teacher-admin.profile.update') }}" method="POST" class="profile-form">
                                    @csrf
                                    @method('PUT')
                        ...
                        <div class="tab-pane fade" id="change-password-tab-pane" role="tabpanel" aria-labelledby="change-password-tab" tabindex="0">
                            <div class="p-4">
                                <form action="{{ route('teacher-admin.password.update') }}" method="POST" class="password-form">
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <div class="form-floating mb-3 password-field">
                                        ...
                                        <div class="password-strength mt-2">
                                            ...
                                            <div class="progress rounded-pill" style="height: 6px;">
                                                <div class="progress-bar bg-primary" role="progressbar" style="width: 0%;" id="password-strength-bar"></div>
                                            </div>
                                        </div>
                                    </div>
...
@media (max-width: 992px) {
    .profile-card, .profile-tabs-card {
