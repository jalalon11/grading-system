                    ...
                    <div class="row">
                        <div class="col-md-5 content-section">
                            ...
                            <div class="alert alert-warning mb-4">
                                <i class="fas fa-exclamation-triangle me-2"></i> The system is currently undergoing scheduled maintenance. Please check back later.
                            </div>
...
<script>
    ...
    function checkMaintenanceStatus() {
        ...
        .then(response => {
            // If we get a redirect response, follow it (likely to login page)
        ...
        .then(data => {
            if (data && !data.maintenance_mode) {
                // If maintenance mode is disabled, redirect to login page
    ...
    // Check maintenance status every 15 seconds
