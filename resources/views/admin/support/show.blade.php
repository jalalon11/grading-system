                        ...
                        <div class="chat-container bg-light rounded-3 border shadow-sm mb-4">
                            ...
                            <div id="messages-container" class="messages-container p-3 position-relative" style="height: 550px; overflow-y: auto; background-color: #f8f9fa;">
                                ...
                                @foreach($messages as $message)
                                    <div class="message-wrapper mb-3 {{ $message->user->role === 'admin' ? 'admin-message' : 'user-message' }}" data-message-id="{{ $message->id }}" data-is-read="{{ $message->is_read ? 'true' : 'false' }}">
                                        <!-- Mobile-optimized message layout -->
                                        <div class="d-flex {{ $message->user->role === 'admin' ? 'justify-content-end' : 'justify-content-start' }}">
                                    ...
                                    <div class="alert alert-secondary mb-0 py-2">
                                        <div class="d-flex align-items-center justify-content-between flex-wrap">
                                            ...
                                            <form id="reopen-form" action="{{ route('admin.support.reply', $ticket->id) }}" method="POST" class="d-none">
                                                @csrf
                                                <input type="hidden" name="message" value="This ticket has been reopened by an administrator.">
                                            </form>
                                        </div>
                                    </div>
                                @endif
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <p class="mb-0 fw-medium">{{ $ticket->school->name }}</p>
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <p class="mb-0">{{ $ticket->user->phone_number ?? 'N/A' }}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
