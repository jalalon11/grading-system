        ...
        <div class="col-lg-8">
            ...
            <div class="card border-0 shadow-sm mb-4">
                <div class="card-header bg-white py-3">
                    <h5 class="mb-0"><i class="fas fa-id-card me-2 text-info"></i>Account Details</h5>
                </div>
                <div class="card-body">
            ...
            <div class="collapse mb-4" id="editProfileForm">
                <div class="card border-0 shadow-sm">
                    <div class="card-header bg-white py-3">
                        <h5 class="mb-0"><i class="fas fa-user-edit me-2 text-info"></i>Edit Profile</h5>
                    </div>
                    <div class="card-body">
            ...
            <div class="collapse" id="changePasswordForm">
                <div class="card border-0 shadow-sm">
                    <div class="card-header bg-white py-3">
                        <h5 class="mb-0"><i class="fas fa-key me-2 text-info"></i>Change Password</h5>
                    </div>
                    <div class="card-body">
