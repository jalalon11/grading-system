                        ...
                        <div class="col-md-4 mb-4">
                            <div class="card h-100 shadow-sm border-0 hover-card">
                                <div class="card-body d-flex flex-column text-center p-4">
                                    ...
                                    <h5 class="card-title fw-bold">DepED School Form 10 (SF10)</h5>
                                    <p class="card-text text-muted flex-grow-1">View performance trends and analytics for your classes.</p>
