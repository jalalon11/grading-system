            ...
            <div class="card shadow-sm border-0">
                <div class="card-header bg-primary text-white py-3">
                    <div class="d-flex justify-content-between align-items-center">
                        <h5 class="mb-0">
                            <i class="fas fa-calendar-week text-white me-2"></i> Weekly Attendance Summary
                        </h5>
                        <div>
                ...
                <div class="card-body p-4">
                    <!-- Filter Form -->
                    <div class="mb-4">
                        <form action="{{ route('teacher.attendances.weekly-summary') }}" method="GET" class="row g-3 align-items-end">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4 d-flex align-items-end">
                                ...
                                <a href="{{ route('teacher.attendances.weekly-summary') }}" class="btn btn-outline-secondary">
                        ...
                        <div class="card border-0 shadow-sm mb-4">
                            <div class="card-header bg-light py-3">
                                <h5 class="mb-0">
                                    ...
                                    Weekly Overview ({{ now()->startOfWeek()->format('M d') }} - {{ now()->endOfWeek()->format('M d') }})
                                </h5>
                            </div>
                            <div class="card-body p-4">
                                <div class="row g-4">
